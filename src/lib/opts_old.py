...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_ckpt',default='./AIC2018_iamai/ReID/ReID_CNN/models/model_880_base.ckpt',help='path to load ckpt')
    self.parser.add_argument('--n_layer',type=int,default=50,help='number of Resnet layers')
